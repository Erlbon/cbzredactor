...
- [rarfile](https://github.com/markokr/rarfile) -- optional CBR reading (Import > Convert to CBZ)
- [py7zr](https://github.com/miurahr/py7zr) -- optional CB7 reading (Import > Convert to CBZ)
